...
export default function PublicationsSection() {
  return (
    <section id="publications" className="relative min-h-screen py-16 md:py-24 overflow-hidden flex items-center justify-center">
      <Image
        src="https://images.pexels.com/photos/36487/above-adventure-aerial-air.jpg"
